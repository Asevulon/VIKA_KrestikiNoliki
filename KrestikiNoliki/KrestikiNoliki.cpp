...
// KrestikiNoliki.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKrestikiNolikiApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKrestikiNolikiApp

CKrestikiNolikiApp::CKrestikiNolikiApp()
{
...
// Единственный объект CKrestikiNolikiApp

CKrestikiNolikiApp theApp;


// Инициализация CKrestikiNolikiApp

BOOL CKrestikiNolikiApp::InitInstance()
{
